    ...
    <section className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-700">
          ...
          Angular to Python, Goland, and more - his expertise in the field is
        ...
        <p className="mt-4 text-lg text-gray-700">
          ...
          down a path of self-discovery, taking advantage of eevery resource
          available to him - from online tutorials to workshops and beyond. With
          his tireless efforts, HuXn has earned his badge as truly talented
          UI/UX Designer.
        </p>
      </div>
    </section>
